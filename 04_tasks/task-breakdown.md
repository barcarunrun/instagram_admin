...
| TASK-041               | 実装済み   | 未着手     | 未確認   | KPI 集計を未実行件数を含む定義へ補正済み。                                                                                                                                                                                                                  |
| TASK-042               | 実装済み   | 未着手     | 未確認   | `/dashboard/summary` を追加し、`/dashboard/kpi` `alerts` `calendar/events` も期間指定対応済み。                                                                                                                                                            |
| TASK-043               | 実装済み   | 未着手     | 未確認   | ダッシュボード UI を動的データへ接続し、失敗一覧、未実行一覧、再認可一覧を表示可能。                                                                                                                                                                        |
| TASK-044               | 実装済み   | 未着手     | 未確認   | 投稿カレンダー画面を追加し、Day / Week / Month 切替と状態表示を実装済み。                                                                                                                                                                                  |
| TASK-045               | 実装済み   | 未着手     | 未確認   | KPI 未達アラートを dashboard alert に統合済み。                                                                                                                                                                                                             |
| TASK-046               | 実装済み   | 実装済み   | 未確認   | [05_source_code/frontend/e2e/operations-visibility.spec.ts](05_source_code/frontend/e2e/operations-visibility.spec.ts) で KPI 表示、カレンダー表示、失敗投稿識別、未達アラート、再認可対象表示を自動化済み。                                                |
